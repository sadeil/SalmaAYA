...
const translations = {
  ...
  "Subscription starts after approval": "يبدأ الاشتراك بعد الاعتماد",
  ...
  "Online": "متصل",
  "Backend connected": "متصل بالخادم",
  ...
  ,"Core application services are reachable through the backend API.": "خدمات التطبيق الأساسية متاحة عبر واجهة الخادم."
  ,"Authentication API": "واجهة المصادقة"
  ,"Doctor reviews": "مراجعات الطبيب"
  ,"Refund ledger": "سجل الاسترداد"
  ...
  ,"Payment collection is intentionally deferred until a doctor approves the care plan, so the current deployment does not collect or store card details.": "يتم تأجيل تحصيل الدفع حتى يعتمد الطبيب خطة الرعاية، لذلك لا يجمع هذا الإصدار بيانات البطاقة أو يخزنها."
